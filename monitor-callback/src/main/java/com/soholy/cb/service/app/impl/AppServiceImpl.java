...
public class AppServiceImpl implements AppService {
    ...
    public JSONObject createCancelAndRevoke_V4(Integer pageNo, Integer pageSize, String taskId, String deviceId,
        ...
        HttpClientUtil.HttpResult resp = HttpClientUtil.executeHttpParams(url, "GET", null, authService.setAuthentication(),
    ...
    public JSONObject callDevice(String deviceId, String serviceId, CommandNA2CloudHeader header, JSONObject body)
        ...
        HttpClientUtil.HttpResult resp = HttpClientUtil.executeHttpParams(url, "POST", null, authService.setAuthentication(),
                paramsObj.toJSONString(), null);
    ...
    public JSONObject findTask(String taskId) throws Exception {
        ...
        HttpClientUtil.HttpResult resp = HttpClientUtil.executeHttpParams(url, "GET", null, authService.setAuthentication(), null,
                null);
        if (resp == null || resp.getStatusCode() != 200 || resp.getContent() == null) {
    ...
    public JSONObject toUpdateRule(RuleDTO1_2 ruleDTO1_2) throws Exception {
        ...
        HttpClientUtil.HttpResult resp = HttpClientUtil.executeHttpParams(url, "PUT", null, authService.setAuthentication(),
                JSONObject.toJSONString(ruleDTO1_2), null);
        if (resp == null || resp.getStatusCode() != 200 || resp.getContent() == null) {
    ...
    public JSONObject modifyRule(String ruleId, String status) throws Exception {
        ...
        HttpClientUtil.HttpResult resp = HttpClientUtil.executeHttpParams(url, "PUT", null, authService.setAuthentication(), null,
                null);
        if (resp == null || resp.getStatusCode() != 200 || resp.getContent() == null) {
    ...
    public boolean deleteRule(String ruleId) throws Exception {
        ...
        HttpClientUtil.HttpResult resp = HttpClientUtil.executeHttpParams(url, "DELETE", null, authService.setAuthentication(), null,
                null);
