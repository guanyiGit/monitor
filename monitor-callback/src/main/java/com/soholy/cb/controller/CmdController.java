...
public class CmdController {
     ...
     * @Description (发送命令)
     */
    //http://localhost:8000/command/45f407f7-558d-4757-b182-9e18a7927062?cmdType=1&cmdValue=-1
    ...
    public R sendCmd(@PathVariable(value = "deviceIdIot") String deviceIdIot,
        ...
        return R.ok(cmdService.sendCommand(cmdTypeEu, cmdValue, mid, deviceIdIot));
    }
